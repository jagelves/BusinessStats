...
## Frequency Distributions in Excel (Numerical)
...
**Example:** Let's use the Dow Jones stock price data to construct a frequency distribution. Download the data below and follow the steps.
