...
**Example:** Let's use the food data to construct a frequency distribution. Download the data below and follow the steps to build the pivot table. [{{< fa file-excel >}} Download Data](food_data.xlsx){.btn .btn-success}
