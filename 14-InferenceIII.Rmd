...
2.  Specify the **confidence level** (i.e., the proportion of times that the hypothesis would hold true) and **significance** level (i.e. the false positive tolerance). Confidence levels are usually set at, $0.90$, $0.95$, or $0.99$, which correspond to $10$%, $5$%, and $1$% significant levels, respectively.
