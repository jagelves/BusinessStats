...
Association still belongs to the *describe* stage of learning from data —
here we characterize how two variables move together — but it also points
ahead to inference, where we will ask whether a relationship seen in a
sample is real or merely a product of chance.
