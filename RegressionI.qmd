...
1. Calculate the correlation coefficient between `hp` and `mpg`. Is
the relationship direct or inverse? How strong is it? Interpret the
result.
...
in Excel. Add a linear trend line. Describe the pattern you observe.

<details>
<summary>Answer</summary>
<div style="padding-left: 1.5em;">

*The scatter diagram is downward sloping: as horsepower increases,
miles per gallon tends to decrease. The points lie moderately close
to the trend line, which is consistent with the moderately strong
inverse correlation of $-0.78$.*
...
*The scatter diagram shows a direct relationship: institutions whose
graduates have higher median earnings also tend to have higher median
debt. The upward pattern is moderate rather than tight, with a fair
amount of scatter around the trend line.*

</div>
</details>

2. Calculate the correlation coefficient and the coefficient of
determination between the two variables. Is the relationship direct
or inverse? How strong is it? What percentage of the variation in
