...
### Variance Intuition
Let's consider a sample of the price of Ether (a famous cryptocurrency). Below is a graph of the prices:
...
Treating this as a sample, we calculate the variance step by step.
