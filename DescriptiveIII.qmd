...
- `=SUMPRODUCT()` multiplies corresponding values in two ranges and returns their sum, useful for calculating the weighted mean.
...
knitr::include_graphics("images/Central_Location.png")
```
