...
-   The `average()` function calculates the average for a vector of numbers.

-   The `median()` function calculates the median for a vector of numbers.

-   The `()` function generates the frequency distribution so that we can identify the mode or modes.
