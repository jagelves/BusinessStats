...
The **expected value** is given by $E(x)=\frac {a+b}{2}$, where $a$ is the lower bound of the distribution, and $b$ is the upper bound.

The **variance** is given by $var(x)=\frac {(n^2-1)}{12}$.
